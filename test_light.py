...
if __name__ == '__main__':
    ...
    weights_path = os.path.join(script_directory, 'Model_DATA','yolov7_light', 'weights', 'best.pt') #weights file path
    source_path = '/Users/maniksinghsarmaal/Downloads/z.mp4' # Path of your image, video, or webcam (0 for default webcam)
